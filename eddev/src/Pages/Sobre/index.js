  ...
  return (
    <div className="container-sobre">
      ...
      <div className="rigth-sobre">
        ...
        <p>
          Mas não pude me dedicar às minhas paixões, em meio às circunstâncias da vida, até eu receber uma oferta de bolsa de estudo para um curso profissionalizante Web Dev Full Stack, em 2021, da parceiria iFood + Cubos Academy. Foram 750 horas de aula, numa rotina intensa com dedicação integral, durante 6 meses, aprendendo FrontEnd, Back-End e Soft Skills. Na sequência, o iFood abriu um processo seletivo para admissão no projeto iLab, e depois de três etapas, fui aprovado. O meu sim veio! O match perfeito!
        </p>
        <p>
          Então, aos 34 anos de idade, recém-casado e com filho de 1 ano, recém-órfão de pai e com uma parte de uma propriedade rural de herança, eis a oportunidade de viver apaixonadamente tech 'n roots, sendo FoodLover.
